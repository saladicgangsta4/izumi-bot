...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID || "izumi~cesitobuso",
  ...
  OWNER_NAME: process.env.OWNER_NAME || "gangsta",
  BOT_NAME: process.env.BOT_NAME || "gangsta-ᴍᴅ",
  ...
  PROCESSNAME: process.env.PROCESSNAME || "gangsta",
